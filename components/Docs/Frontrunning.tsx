...
export default function Frontrunning() {
  return (
    <div>
      ...
      <ul>
        <li>
          RPC Endpoint used is{" "}
          <code>api.sushirelay.com/v1</code>
        </li>
        <li>
      ...
      <p>
        Trades submitted are categorized according to their function calls, implemented by <code>0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F</code>{" "}
...
`}
  ...
  `}
      />
        This dynamically adds and removes
