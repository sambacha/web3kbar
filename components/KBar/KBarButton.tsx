...
type TKBarButtonType = IKBarButtonProps & React.ComponentProps<'button'>;

const KBarButton: FunctionComponent<TKBarButtonType> = ({
  className,
  isDarkMode,
  onClick,
  ...rest
  ...
  <button
    ...
    className={concatClassNames(
      className || '',
      'flex align-middle rounded-md bg-transparent w-6 h-6 border-0 cursor-pointer outline-none',
    )}
    {...rest}
  >
    <svg
